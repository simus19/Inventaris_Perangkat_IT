                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="text-right">
                            <a href="{{ url('administrator/dataaplikasi/add') }}" class="btn btn-success">Tambah Data</a>
                        </div>
                    </div>
                  </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: inline-flex;" class="">
                                    <a href="{{ url('/administrator/dataaplikasi/edit/'.$data->id) }}" class="btn btn-info btn-sm mr-1"><i class="fas fa-edit"></i></a> 
