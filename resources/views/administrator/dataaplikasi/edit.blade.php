    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="mt-0 font-weight-bold text-success">Form Edit Data Aplikasi</h6>
            </div>
            <div class="card-body">
                <form action="{{ url('administrator/dataaplikasi/update/'.$dataaplikasi->id) }}" method="post"> @csrf
                <div class="row">

                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            <label for="unitcode">IP Aplikasi<sup class="text-danger">*</sup></label>
                            <input class="form-control" type="text" name="ip_aplikasi" id="ip_aplikasi" value="{{ $dataaplikasi->ip_aplikasi }}">
                    ...
                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nama_aplikasi" id="nama_aplikasi" value="{{ $dataaplikasi->nama_aplikasi }}">
                    ...
                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="deskripsi" id="deskripsi" value="{{ $dataaplikasi->deskripsi }}">
                    ...
                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tahun_buat" id="tahun_buat" value="{{ $dataaplikasi->tahun_buat }}">
                    ...
                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="bahasaprogram" id="bahasaprogram" value="{{ $dataaplikasi->bahasaprogram }}">
                    ...
                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="database" id="database" value="{{ $dataaplikasi->database }}">
                    ...
                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="user" id="user" value="{{ $dataaplikasi->user }}">
                    ...
                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ $dataaplikasi->status }}">
