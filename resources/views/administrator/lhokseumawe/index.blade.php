    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-6">
                        <h6 class="mt-2 font-weight-bold text-success">Lhokseumawe</h6>
                    </div>
                    <div class="col-6">
                        <div class="text-right">
                            <a href="{{ url('administrator/lhokseumawe/add') }}" class="btn btn-success">Tambah Data</a>
                        </div>
                    </div>
                  </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: inline-flex;" class="">
                                    <a href="{{ url('/administrator/lhokseumawe/edit/'.$data->id) }}" class="btn btn-info btn-sm mr-1"><i class="fas fa-edit"></i></a> 
                                    <a href="{{ url('/administrator/lhokseumawe/del-lhokseumawe/'.$data->id) }}" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
