    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="mt-0 font-weight-bold text-success">Form Edit Gandapura</h6>
            </div>
            <div class="card-body">
                <form action="{{ url('administrator/gandapura/update/'.$gandapura->id) }}" method="post"> @csrf
                <div class="row">

                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            <label for="unitcode">Nama Perangkat<sup class="text-danger">*</sup></label>
                            <input class="form-control" type="text" name="nama_perangkat" id="nama_perangkat" value="{{ $gandapura->nama_perangkat }}">
                    ...
                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="merk" id="merk" value="{{ $gandapura->merk }}">
                    ...
                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tipe" id="tipe" value="{{ $gandapura->tipe }}">
                    ...
                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="koordinat_longtitude" id="koordinat_longtitude" value="{{ $gandapura->koordinat_longtitude }}">
                    ...
                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="koordinat_langtitude" id="koordinat_langtitude" value="{{ $gandapura->koordinat_langtitude }}">
                    ...
                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="alamat" id="alamat" value="{{ $gandapura->alamat }}">
