...
<div class="row">
    <div class="col-12">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="{{ url('administrator/datapemeliharaan/store') }}" method="post" enctype="multipart/form-data"> @csrf
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="jenis_kegiatan" id="exampleRadios1" value="prediktif" >
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-check">
                                      <input class="form-check-input" type="radio" name="jenis_kegiatan" id="exampleRadios2" value="korektif">
                    ...
                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="waktu" id="waktu" value="{{ old('waktu') }}">
                    ...
                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pelaksana" id="pelaksana" value="{{ old('pelaksana') }}">
                    ...
                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            {{-- <input type="hidden" name="oldImgeFile", value="{{ $artikel->url_img }}"> --}}
                    ...
                    <div class="col-xl-6 col-ms-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="kebutuhan_item" id="kebutuhan_item" value="{{ old('kebutuhan_item') }}">
